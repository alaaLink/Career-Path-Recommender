...
namespace CareerPathRecommender.Web.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MentorEmployeeId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Recommendations_Employees_MentorEmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recommendations_MentorEmployeeId",
                table: "Recommendations",
