...
public class RecommendationService : IRecommendationService
{
    ...
    private Dictionary<string, SkillLevel> GetTargetPositionSkillRequirements(string targetPosition)
    {
        ...
        switch (targetPosition.ToLower())
        {
            case var p when p.Contains("senior") && (p.Contains("developer") || p.Contains("engineer")):
                requirements = RecommendationConsts.SeniorRequirements;
                break;

            case var p when p.Contains("lead") || p.Contains("team lead"):
                requirements = RecommendationConsts.LeadRequirements;
                break;

            case var p when p.Contains("manager") || p.Contains("engineering manager"):
                requirements = RecommendationConsts.ManagerRequirements;
                break;

            case var p when p.Contains("architect"):
                requirements = RecommendationConsts.ArchitectRequirements;
                break;

            case var p when p.Contains("full stack"):
                requirements = RecommendationConsts.FullstackRequirements;
                break;

            default:
                // Default requirements for general developer positions
                requirements = RecommendationConsts.DefaultRequirements;
                break;
        }
    ...
    {
        var highDemandKeywords = RecommendationConsts.HighDemandKeywords;
    ...
    {
        var relatedDepts = RecommendationConsts.RelatedDepts;
    ...
    private bool IsOnSameCareerTrack(string mentorPosition, string employeePosition, string mentorDepartment, string employeeDepartment)
    {
        ...
        var careerTracks = RecommendationConsts.CareerTracks;
    ...
    {
        var seniorityKeywords = RecommendationConsts.SeniorityKeywords;
